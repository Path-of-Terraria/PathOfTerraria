...
{
	/// <summary>  Enumerator, to be used within a foreach. </summary>
	...
	/// <summary> Enumerator, to be used within a foreach. Every enumeration step should update <see cref="Result.IsPointFree"/>. </summary>
	public ref struct FloodFill
	{
		...
		public bool MoveNext()
		{
			...
			if (stackReads < stackWrites)
			{
				...
				Current = new Result(globalPoint, MemoryMarshal.CreateSpan(ref isPointFree, 1));
				isPointFree = true;
