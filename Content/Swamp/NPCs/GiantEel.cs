...
internal class GiantEel : ModNPC
{
	...
	public override void AI()
	{
		...
		{
			float aggro = targetPlayer.HasBuff<SwampAlgaeBuff>() ? 3100 : 2200;//Utils.Remap(targetPlayer.Center.Y / 16f, 40, SwampArea.FloorY, 3000, 1200, true) * (targetPlayer.HasBuff<SwampAlgaeBuff>() ? 1.3333f : 1);
