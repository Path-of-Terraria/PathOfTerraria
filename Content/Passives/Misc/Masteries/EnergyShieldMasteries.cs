...
internal class KineticBulwarkMastery : Passive
{
	internal class EnergyShieldDamagePlayer : ModPlayer
	{
		public override void PostUpdateEquips()
		{
			if (!Player.GetModPlayer<PassiveTreePlayer>().TryGetCumulativeValue<KineticBulwarkMastery>(out float value))
			{
				return;
			}
...
internal class EldritchMasteryMastery : Passive
{
...
internal class CuratorMastery : Passive
{
	public override void BuffPlayer(Player player)
	{
		if (!player.GetModPlayer<PassiveTreePlayer>().TryGetCumulativeValue<CuratorMastery>(out float value))
		{
			return;
		}
