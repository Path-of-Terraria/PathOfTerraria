...
internal class MeleePassive : Passive
{
	public MeleePassive()
	{
		...
		MaxLevel = 5;
		TreePositions = [new Vector2(250, 300)];
	}
...
internal class MagicPassive : Passive
{
	public MagicPassive()
	{
		...
		MaxLevel = 5;
		TreePositions = [new Vector2(450, 250)];
	}
