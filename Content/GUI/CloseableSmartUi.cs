...
namespace PathOfTerraria.Content.GUI
{
    public abstract class CloseableSmartUi : SmartUIState
    {
        ...
        protected virtual void CreateMainPanel(bool showCloseButton = true, Point? panelSize = null, bool canResize = true)
        {
            ...
            if (IsCentered)
            {
                Panel.Left.Set(-panelSize.Value.X / 2f, 0.5f);
                Panel.Top.Set(-panelSize.Value.Y / 2f, 0.5f);
            }
            else
            {
