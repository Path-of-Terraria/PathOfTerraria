using PathOfTerraria.Content.Items.Placeable.Mech;
...
public class MechChest : ModTile
{
	public override void SetStaticDefaults()
	{
		...
		RegisterItemDrop(ModContent.ItemType<MechChestItem>());
	...
	public override void MouseOver(int i, int j)
	{
		...
		else
		{
			...
			{
				player.cursorItemIconID = ModContent.ItemType<MechChestItem>();
