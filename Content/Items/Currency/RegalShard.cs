...
public class RegalShard : CurrencyShard
{
	...
	public override void ApplyToItem(Item slotItem)
	{
		...
		// Add the new affix before regenerating the name so the name reflects all current affixes,
		// including the newly added one, and respects the Rare rarity naming conventions.
