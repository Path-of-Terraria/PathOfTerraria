...
public abstract class Gear : PoTItem
{
	...
	public sealed override void SwapItemModifiers(EntityModifier swapItemModifier)
	{
		...
		else if (Item.damage > 0)
		{
			...
			{
				gear.ApplyAffixes(swapItemModifier, null);
			}
		}
	}
