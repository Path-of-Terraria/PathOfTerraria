...
/// <summary>
/// Tracks the global duration multiplier accumulated from passives and other
/// sources.  A value of <c>0.25f</c> means +25% duration, while <c>-0.25f</c> means -25% duration.
/// </summary>
/// <remarks>
...
/// to by passives such as <c>IncreasedDurationPassive</c> and <c>DecreasedDurationPassive</c>.  
/// Buff and skill durations are handled directly via <see cref="BuffModifierPlayer.BuffBonus"/> and
/// <see cref="SkillPlayers.SkillCombatPlayer.GlobalBuff"/> respectively.
/// </remarks>
public class DurationPlayer : ModPlayer
{
	/// <summary>
	/// Accumulated bonus to all durations this frame, as a fraction (e.g. 0.25 = +25%, -0.25 = -25%).
...
/// who has a non-zero <see cref="DurationPlayer.DurationModifier"/>.
/// </summary>
internal class DurationGlobalProjectile : GlobalProjectile
{
	public override void OnSpawn(Projectile projectile, IEntitySource source)
	{
		...
		float modifier = player.GetModPlayer<DurationPlayer>().DurationModifier;
		...
		projectile.timeLeft = Math.Max(1, (int)(projectile.timeLeft * (1f + modifier)));
	}
}