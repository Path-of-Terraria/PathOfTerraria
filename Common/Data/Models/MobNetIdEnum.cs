...
/// <summary>
/// The purpose of this is to provide a way to reference the NetId of a mob without having to remember the number or go digging into NPCID
/// </summary>
public enum MobNetIdEnum
{
    NegativeIDCount = -66,
    BigHornetStingy = -65,
