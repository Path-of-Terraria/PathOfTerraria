...
internal class ItemSpawner
{
	...
	public static int SpawnItem<T>(Vector2 pos, int itemLevel = 0, Rarity rarity = Rarity.Normal) where T : ModItem
	{
	...
	/// <param name="itemLevel">The item level of the item to spawn</param>
	/// <param name="dropRarityModifier">Rolls an item with a drop rarity modifier</param>
	public static int SpawnItemFromCategory<T>(Vector2 pos, int itemLevel = 0, Rarity rarity = Rarity.Normal) where T : ModItem
	{
