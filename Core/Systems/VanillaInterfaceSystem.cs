...
using static PathOfTerraria.Core.Systems.VanillaInterfaceSystem;

namespace PathOfTerraria.Core.Systems;

/// <summary>
///		Provides APIs for handling interfaces normally implemented by mod
///		content with vanilla content.
/// </summary>
public sealed class VanillaInterfaceSystem : ModSystem
{
